...
const state = readline.question('Digite o estado que deseja saber a porcentagem do faturamento: ');
...
console.log(`${state} tem ${porcent.toFixed(4)}% do faturamento total: R$${sum}`);